...
const ThemeToggle = () => {
  ...
  return (
    ...
    >
      ...
      {/* Sun Icon */}
      <span
        className={`absolute left-1.5 top-1.5 w-3 h-3 transition-opacity duration-200 ${
      ...
      {/* Moon Icon */}
      <span
        className={`absolute right-1.5 top-1.5 w-3 h-3 transition-opacity duration-200 ${
